...
def test_first_question_first_choice(driver, login):
...
def test_first_question_second_choice(driver, login):
    driver.get("http://127.0.0.1:8000/polls/1/")
    driver.find_element(By.ID, "choice2").click()
    driver.find_element(By.ID, "vote").click()
    WebDriverWait(driver, 10).until(
        lambda x: x.find_element(By.ID, "vote_again"))
    el = driver.find_element(
...
def test_second_question_first_choice(driver, login):
...
def test_second_question_second_choice(driver, login):
    driver.get("http://127.0.0.1:8000/polls/2/")
    driver.find_element(By.ID, "choice1").click()
    driver.find_element(By.ID, "vote").click()
    WebDriverWait(driver, 10).until(
